...
/**
 * The {@link RedBullSportsCar}.
 * <p>
 * The concrete implementation of the abstract product. 
 * <p>
 * @author szeyick
 */
public class MercedesSportsCar implements IAbstractSportsCar {
	 ...
	 */
	public MercedesSportsCar(String manufacturerName, int numberOfGears, int price) {
